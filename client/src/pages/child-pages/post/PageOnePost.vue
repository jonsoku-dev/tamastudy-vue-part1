    ...
    <article class="post container" v-if="post">
      <div class="post__wrapper">
        <div class="post__thumbnail">
          <img :src="post.images[0]" alt="food" />
        </div>
        <div class="post__header pd16">
          ...
          <div class="post__info">
            <p class="post__author">{{ post.user && post.user.username }}</p>
        ...
        <div class="post__content pd16">
          <div class="post__content1">
            <strong class="post__title post__title--main">타마반점</strong>
            <span class="post__title post__title--sub">가상의 중국집</span>
          </div>
          ...
          <div class="post__content3">
            ...
            <div class="post__etc post__etc--comment">
              ...
              <span>{{ post.likes && post.comments.length }}</span>
            </div>
          </div>
        </div>
        <div class="post__description">
          <p class="post__desc post__desc--text" v-html="post.description"></p>
        </div>
      </div>
    </article>
